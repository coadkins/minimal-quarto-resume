...
#show: resume.with(
  author: (
    firstname: unescape_text("Merlin"),
    lastname: unescape_text("Ambrosius"),
    address: unescape_text("Glastonbury, UK"),
    position: unescape_text(""),
    contacts: ((
      text: unescape_text("merlin\@avalon.edu"),
      url: unescape_text("mailto:merlin\@avalon.edu"),
      icon: unescape_text("fa envelope"),
    ), (
      text: unescape_text("GitHub"),
      url: unescape_text("https:\/\/github.com/merlin"),
      icon: unescape_text("fa brands github"),
    ), (
      text: unescape_text("LinkedIn"),
      url: unescape_text("https:\/\/linkedin.com/in/merlin"),
...
= Education
<education>
#resume-entry(title: "Master of Science (MS), Political Science",location: "Cambridge, MA",date: "09/2025",description: "Massachusetts Institute of Technology",)
#resume-item(([Passed doctoral exams in models and methods],))
#resume-entry(title: "Juris Doctor (JD)",location: "New Haven, CT",date: "09/2016",description: "Yale University",)
#resume-item(([Passed NY Bar Exam],))
#resume-entry(title: "Bachelor of Arts (BA), Philosophy",location: "Durham, NC",date: "05/2013",description: "Duke University",)
#resume-item(([Benjamin N. Duke Scholarship],
[High Distinction],))
= Experience
<experience>
#resume-entry(title: "PhD Candidate Researcher",location: "Cambridge, MA",date: "09/2020 - 09/2025",description: "MIT",)
#resume-item(([Wide variety of data work and responsibilities],
[Advanced proficiency in modeling],
[Experience with very large data sets],))
#resume-entry(title: "Corporate Attorney",location: "New York, NY",date: "09/2016 - Present",description: "Large Law Firms",)
#resume-item(([Led important matters],
[Did many good deeds],))
= Skills
<skills>
#skills-entry((
...
[Python],
[#link("https://github.com/coadkins/minimal-quarto-resume")[R]],
[SQL],
)),
))
